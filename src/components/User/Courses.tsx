        ...
        >
          ...
          <>
            ...
            <div className="flex-grow">
              ...
              <p className="py-1 text-sm font-medium text-gray-500 truncate font-dosis">{detail.title}</p>
              <p className="py-1 text-sm font-medium text-gray-500 truncate font-dosis">{detail.value}</p>
              </div>
                  ))
              }
            </div>
