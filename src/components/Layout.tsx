...
const navigation = [
  ...
  { name: 'Courses', href: '/courses', icon: FolderIcon },
  { name: 'Take Test', href: '/ca', icon: BookmarkAltIcon }
]
                ...
                <nav className="px-2 mt-5 space-y-1">
                  {navigation.map((item) => (
                    ...
                    >
                      <item.icon
                        className={classNames(
                          item.name === page ? 'text-gray-300' : 'text-gray-400 group-hover:text-gray-300',
                          'mr-4 h-6 w-6'
                        )}
                        aria-hidden="true"
                      />
